...
const FALLBACK = 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=800&q=60'
  ...
  >
    <div class="tcard-img-wrap">
      <img
        ...
        decoding="async"
      />
      <span v-if="!tool.is_available" class="tcard-badge tcard-badge-rented">Jelenleg bérbe adva</span>
...
.tcard-loc svg { width: 0.85rem; height: 0.85rem; flex-shrink: 0; color: var(--color-accent); }
